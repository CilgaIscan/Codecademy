// Import the MessageMixer module.
import MessageMixer from './message-mixer.js';

// Declare a function to test module functions.
function displayMessage() {
    ...
    console.log(MessageMixer.palindrome("What is the color of the sky?", "sky", "water"));
